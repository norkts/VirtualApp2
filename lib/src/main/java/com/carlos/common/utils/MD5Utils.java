...
public class MD5Utils {
   ...
   public static String md5Encode(String inStr) {
      ...
      try {
         md5 = MessageDigest.getInstance(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("OwYpIw==")));
         byte[] byteArray = inStr.getBytes(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("IQUqW3pTRVo=")));
   ...
   public static String binToHex(byte[] md) {
      ...
      for(int i = 0; i < md.length; ++i) {
         ...
         if (read < 16) {
            sb.append(StringFog.decrypt(com.kook.librelease.StringFog.decrypt("OhhSVg==")));
         }
   ...
   public static String fileMD5Sync(File file) {
      if (file != null && file.exists()) {
         ...
         try {
            ...
            String md5;
            for(md5 = bigInt.toString(16); md5.length() < 32; md5 = StringFog.decrypt(com.kook.librelease.StringFog.decrypt("OhhSVg==")) + md5) {
            }
