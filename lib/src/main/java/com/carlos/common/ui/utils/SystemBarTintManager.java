...
public class SystemBarTintManager {
   ...
   public static class SystemBarConfig {
      ...
      private int getNavigationBarWidth(Context context) {
         Resources res = context.getResources();
         int result = 0;
         return VERSION.SDK_INT >= 14 && this.hasNavBar(context) ? this.getInternalDimensionSize(res, NAV_BAR_WIDTH_RES_NAME) : result;
      }
      ...
      // $FF: synthetic method
      SystemBarConfig(Activity x0, boolean x1, boolean x2, Object x3) {
         this(x0, x1, x2);
      }
   }
}
