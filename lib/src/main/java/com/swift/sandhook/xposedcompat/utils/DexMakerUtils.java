...
public class DexMakerUtils {
   ...
   public static void autoBoxIfNecessary(Code code, Local<Object> target, Local source) {
      ...
      if (typeId.equals(TypeId.BOOLEAN)) {
         ...
         code.loadConstant(target, (Object)null);
      } else {
   ...
   public static void autoUnboxIfNecessary(Code code, Local target, Local source, Map<TypeId, Local> tmpLocals, boolean castObj) {
      ...
      if (typeId.equals(TypeId.BOOLEAN)) {
         ...
         boxTypedLocal = (Local)tmpLocals.get(boxTypeId);
   ...
   public static Map<TypeId, Local> createResultLocals(Code code) {
      ...
      code.loadConstant(charObjLocal, (Object)null);
      code.loadConstant(doubleObjLocal, (Object)null);
      code.loadConstant(floatObjLocal, (Object)null);
      code.loadConstant(intObjLocal, (Object)null);
      code.loadConstant(longObjLocal, (Object)null);
      code.loadConstant(shortObjLocal, (Object)null);
      code.loadConstant(voidObjLocal, (Object)null);
   ...
   public static void returnRightValue(Code code, Class<?> returnType, Map<Class, Local> resultLocals) {
      code.returnValue((Local)resultLocals.get(returnType));
   }
