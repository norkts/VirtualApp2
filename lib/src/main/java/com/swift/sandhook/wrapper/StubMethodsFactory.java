...
public class StubMethodsFactory {
   ...
   public static synchronized Method getStubMethod() {
      ...
      try {
         ++curStub;
         Class proxyClass = (Class)proxyGenClass.invoke((Object)null, "SandHookerStubClass_" + curStub, null, StubMethodsFactory.class.getClassLoader(), new Method[]{proxyGenClass}, null);
